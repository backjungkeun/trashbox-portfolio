/**
 * SmartEditor2 NAVER_Library:SE2.8.2.O12056 Copyright NAVER Corp. Licensed
				...
				for (var e = 0, g = a.length; e < g; e++) {
					...
					if (b && b.align !== b.style.textAlign) {
						...
						for(var x=0; x < b.childNodes.length; x++) {
							if(b.childNodes[x].tagName === "IMG") {
							//	console.log("align :: " + d);
							//	console.log("IMG :: " + b.childNodes[x]);
								
								switch(d) {
								    
								    case 'center': b.childNodes[x].setAttribute('class', 'ui centered image');
									break;
									
								    case 'left': b.childNodes[x].setAttribute('class', 'ui left floated image');
								    break;
								    
								    case 'right': b.childNodes[x].setAttribute('class', 'ui right floated image');
									break;
									
								    case 'justify':  b.childNodes[x].removeAttribute('class');
									break;
								}
							}
						}
						...
						if (c.tagName === "DIV" || c.tagName === "P") {
							...
							for(var x = 0; c.childNodes.length; x++) {
								if(c.childNodes[x].tagName === "IMG") {
									console.log("IMG :: " + c.childNodes[x]);
...
nhn.husky.SE_OuterIFrameControl = $Class({
	...
	$ON_SE_FIT_IFRAME : function() {
		this.elIFrame.style.height = document.body.offsetHeight + 50 + "px"
	},
