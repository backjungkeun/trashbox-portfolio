...
<head>
  ...
  $(document)
    .ready(function() {
      ...
      $form = $('.ui.form').not($('.ui.write.form'));
...
//             console.log(userNoList);
           ...
           $('table img').each(function() {
        	   ...
        	   $(this).attr('src', '/trashbox/resources/photo_upload_profile/' + defaultInfoMap[userNo].profileImage);
                  ...
                  <tbody class="collapsing">
                    ...
                    <tr>
                      ...
                      <td class="title">
                       ...
                       <span class="comment num" data-no="${board.no}"><span>[0]</span></span>
                       <br> 
