...
public class MyLoginSuccessHandlerTest extends SimpleUrlAuthenticationSuccessHandler {
	private static final Logger LOG = LogManager.getLogger(MyLoginSuccessHandlerTest.class);
	...
	public MyLoginSuccessHandlerTest(){
		targetUrlParameter = "";
		defaultUrl = "/";
		useReferer = false;
	}
